...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Features Section */
        .features { display: grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap: 1.5rem; padding: 3rem 2rem; max-width: 1400px; margin: 0 auto; }
        .feature-card { background: white; border: 1px solid #e0e0e0; border-radius: 8px; padding: 1.5rem; }
        .feature-card h3 { font-size: 22px; font-weight: 600; margin-bottom: 0.75rem; color: #2c5aa0; }
        ...
        .info-item h4 { font-size: 20px; font-weight: 600; margin-bottom: 0.5rem; color: #1a3a52; }
        .info-item p { font-size: 18px; color: #666; }
        .info-label {font-size: 19px;}
        .info-description {font-size: 17px;}
        ...
        .term-item { background: #f0f4f8; font-size: 18px; padding: 1rem; border-radius: 6px; border-left: 4px solid #2c5aa0; padding: 20px}
        ...
        .faq-question { font-size: 18px; padding: 1.25rem; cursor: pointer; display: flex; justify-content: space-between; align-items: center; font-weight: 600; color: #1a3a52; transition: background 0.2s; }
        .faq-question:hover { background: #f9f9f9; }
        .faq-answer { padding: 0 1.25rem 1.25rem; color: #666; font-size: 16px; display: none; }
        ...
        .form-container h2 { text-align: center; margin-bottom: 2rem; font-size: 26px; font-weight: 600; color: #1a3a52; }
        ...
        label { display: block; margin-bottom: 0.5rem; font-size: 16px; font-weight: 600; color: #1a3a52; }
        input, select { width: 100%; padding: 12px 14px; border: 1px solid #d0dce6; border-radius: 8px; font-size: 16px; font-family: inherit; transition: all 0.25s ease;background: #f9fbfd;}
        ...
        @media (max-width: 768px) {
            ...
            .cta-button { padding: 10px 24px; font-size: 18px; }
            ...
            .terms-section h2 { font-size: 24px; margin-bottom: 1.25rem; }
            .terms-grid { 
                grid-template-columns: 1fr;
                gap: 1rem;
            }
            ...
            .faq-section h2 { font-size: 24px; margin-bottom: 1.5rem; }
            .faq-question { padding: 0.875rem; font-size: 18px; }
            .faq-answer { padding: 0 0.875rem 0.875rem; font-size: 16px; }
            ...
            .form-container h2 { font-size: 24px; margin-bottom: 1.25rem; }
